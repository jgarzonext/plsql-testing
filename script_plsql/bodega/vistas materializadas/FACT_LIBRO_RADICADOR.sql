...
FROM SEGUROS S,  SIN_SINIESTRO si, ASEGURADOS a,    TOMADORES t, benespseg b,
 ...
 ,
   ...
   COMMENT ON MATERIALIZED VIEW "CONF_DWH"."FACT_LIBRO_RADICADOR"  IS 'snapshot table for snapshot DWH_CONF.FACT_LIBRO_RADICADOR';
