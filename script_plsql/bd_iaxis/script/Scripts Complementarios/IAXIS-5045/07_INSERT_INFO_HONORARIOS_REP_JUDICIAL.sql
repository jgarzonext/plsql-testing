INSERT INTO SIN_CODCAUSA(CCAUSIN, CUSUALT, FALTA, CUSUMOD, FMODIFI, CATRIBU) VALUES(9177, 'AXIS', '05-APR-19', NULL, NULL, 7);
...
INSERT INTO SIN_CODMOTCAU(CCAUSIN, CMOTSIN, CUSUALT, FALTA, CUSUMOD, FMODIFI, CNOPERIT)
    VALUES(9177, 0, 'AXIS_CONF', '04-AUG-16', NULL, NULL, NULL);
...
INSERT INTO SIN_GAR_CAUSA(SPRODUC, CACTIVI, CGARANT, CCAUSIN, CMOTSIN, CUSUALT, FALTA, CUSUMOD, FMODIFI, NUMSINI)
    VALUES(8063, 0, 7062, 9177, 0, 'AXIS', '05-APR-19', NULL, NULL, NULL);

--Gastos Judiciales de Defensa / Evento
INSERT INTO SIN_GAR_CAUSA(SPRODUC, CACTIVI, CGARANT, CCAUSIN, CMOTSIN, CUSUALT, FALTA, CUSUMOD, FMODIFI, NUMSINI)
    VALUES(8063, 0, 7042, 9177, 0, 'AXIS', '05-APR-19', NULL, NULL, NULL);	
	
--PARA MEDICAS	*************************************************************************************************************

--Gastos Judiciales de Defensa / Vigencia
INSERT INTO SIN_GAR_CAUSA(SPRODUC, CACTIVI, CGARANT, CCAUSIN, CMOTSIN, CUSUALT, FALTA, CUSUMOD, FMODIFI, NUMSINI)
    VALUES(8062, 0, 7062, 9177, 0, 'AXIS', '05-APR-19', NULL, NULL, NULL);

--Gastos Judiciales de Defensa / Evento
INSERT INTO SIN_GAR_CAUSA(SPRODUC, CACTIVI, CGARANT, CCAUSIN, CMOTSIN, CUSUALT, FALTA, CUSUMOD, FMODIFI, NUMSINI)
    VALUES(8062, 0, 7042, 9177, 0, 'AXIS', '05-APR-19', NULL, NULL, NULL);	
    
--PARA PROFESINOALES *************************************************************************************************************

--INSERT INTO SIN_GAR_CAUSA(SPRODUC, CACTIVI, CGARANT, CCAUSIN, CMOTSIN, CUSUALT, FALTA, CUSUMOD, FMODIFI, NUMSINI)
--VALUES(8064, 0, 7042, 9251, 0, 'AXIS', '05-APR-19', NULL, NULL, NULL);
    
--INSERT INTO SIN_GAR_TRAMITACION(SPRODUC, CACTIVI, CTRAMIT,CGARANT)
--VALUES(8064,0,0,7042);

--INSERT INTO SIN_GAR_CAUSA(SPRODUC, CACTIVI, CGARANT, CCAUSIN, CMOTSIN, CUSUALT, FALTA, CUSUMOD, FMODIFI, NUMSINI)
--VALUES(8064, 0, 7062, 9251, 0, 'AXIS', '05-APR-19', NULL, NULL, NULL);
