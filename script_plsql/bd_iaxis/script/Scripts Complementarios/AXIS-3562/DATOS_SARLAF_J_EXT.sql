...
(
  ...
  (
    records delimited by 0x'0A'
                   logfile 'DATOSSARLAFJ.log'
                   badfile 'DATOSSARLAFJ.bad'
                   discardfile 'DATOSSARLAFJ.dis'
  ...
  location (TABEXT:'DATOSSARLAF_J.csv')
)
reject limit UNLIMITED;

--Grant 
grant select, insert, update, delete on AXIS.DATOS_SARLAF_J_EXT to AXIS00;
