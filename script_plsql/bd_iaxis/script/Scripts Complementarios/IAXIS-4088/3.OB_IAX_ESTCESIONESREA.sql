BEGIN
    pac_skip_ora.p_comprovadrop('OB_IAX_ESTCESIONESREA', 'TYPE');
    pac_skip_ora.p_comprovadrop('T_IAX_ESTCESIONESREA', 'TYPE');
END;
/

CREATE OR REPLACE TYPE "OB_IAX_ESTCESIONESREA" AS OBJECT(
   scesrea        NUMBER(8),
   ncesion        NUMBER(6),
   icesion        NUMBER,
   icapces        NUMBER,
...
/
CREATE OR REPLACE TYPE BODY "OB_IAX_ESTCESIONESREA" AS
   CONSTRUCTOR FUNCTION ob_iax_estcesionesrea
...
END;
/
CREATE OR REPLACE TYPE "T_IAX_ESTCESIONESREA" AS TABLE OF OB_IAX_ESTCESIONESREA;
/
...
/
GRANT EXECUTE ON "AXIS"."OB_IAX_ESTCESIONESREA" TO "AXIS00";
/
GRANT EXECUTE ON "AXIS"."T_IAX_ESTCESIONESREA" TO "R_AXIS";
/
GRANT EXECUTE ON "AXIS"."T_IAX_ESTCESIONESREA" TO "CONF_DWH";
/
GRANT EXECUTE ON "AXIS"."T_IAX_ESTCESIONESREA" TO "PROGRAMADORESCSI";
/
GRANT EXECUTE ON "AXIS"."T_IAX_ESTCESIONESREA" TO "AXIS00";
/
COMMIT;