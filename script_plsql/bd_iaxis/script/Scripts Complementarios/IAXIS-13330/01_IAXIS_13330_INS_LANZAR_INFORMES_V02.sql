...
values (24, 'AXISLIST003', 'PreValMovResSiniestros', 'GENERAL', 0, 'GENERAL', 'PSPROCES', 1, 9000526, 3, 1, null);
--
insert into cfg_lanzar_informes_params (CEMPRES, CFORM, CMAP, TEVENTO, SPRODUC, CCFGFORM, TPARAM, NORDER, SLITERA, CTIPO, NOTNULL, LVALOR)
values (24, 'AXISLIST003', 'PreValMovResSiniestros', 'GENERAL', 0, 'GENERAL', 'PFPERINI', 1, 9000527, 3, 1, null);
--
insert into cfg_lanzar_informes_params (CEMPRES, CFORM, CMAP, TEVENTO, SPRODUC, CCFGFORM, TPARAM, NORDER, SLITERA, CTIPO, NOTNULL, LVALOR)
values (24, 'AXISLIST003', 'PreValMovResSiniestros', 'GENERAL', 0, 'GENERAL', 'PFPERFIN', 3, 9000493, 2, 1, null);
-- DET_LANZAR_INFORMES
