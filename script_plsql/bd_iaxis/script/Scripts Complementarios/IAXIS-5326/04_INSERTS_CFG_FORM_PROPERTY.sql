...
BEGIN
	...
	DELETE FROM CFG_FORM WHERE SPRODUC = 8062 AND CMODO = 'SUPLEMENTO_685' AND CFORM = 'AXISCTR207'; 
    ...
    LOOP   
        ...
        VALUES(24, 'AXISCTR207', 'SUPLEMENTO_685', C.CCFGFORM, 8062, VCIDCFG, 'AXIS', SYSDATE(), NULL, NULL);
    END LOOP;
