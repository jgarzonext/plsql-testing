CREATE OR REPLACE PACKAGE "PAC_IAX_FINANCIERA" AS
/******************************************************************************
   ...
   ---------  ----------  ---------------  ------------------------------------
   1.0        17/06/2016   ERH               1. CreaciÃ³n del package.
   ...
   4.0      31/05/2019  Krishnakant    4.0 IAXIS-3674:AMPLIACIN DE LOS CAMPOS DE CONCEPTOS               
******************************************************************************/
...
/**********************************************************************
      ...
      return             : 0 todo ha sido correcto
                           1 ha habido un error
     **********************************************************************/
     --AABC 07/03/2019 Validacion del fin_general_det
      FUNCTION f_grabar_general_det(
         psfinanci IN NUMBER,
          pnmovimi IN NUMBER,
            pcmodo IN VARCHAR2,
    ...
    /**********************************************************************
      ...
      Función que elimina los datos de la tabla FIN_GENERAL_DET
      Param IN psfinanci: sfinanci
      Param IN pnmovimi: nmovimi
      Param OUT PRETCURSOR : SYS_REF_CURSOR
     **********************************************************************/
