--------------------------------------------------------
--  DDL for Package PAC_MD_MARCAS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "AXIS"."PAC_MD_MARCAS" AS
  /******************************************************************************
...
/
  ...
  GRANT EXECUTE ON "AXIS"."PAC_MD_MARCAS" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."PAC_MD_MARCAS" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."PAC_MD_MARCAS" TO "PROGRAMADORESCSI";
