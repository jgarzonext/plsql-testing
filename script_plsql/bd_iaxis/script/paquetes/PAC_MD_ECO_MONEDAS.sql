--------------------------------------------------------
--  DDL for Package PAC_MD_ECO_MONEDAS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "AXIS"."PAC_MD_ECO_MONEDAS" AS
/******************************************************************************
   NOMBRE:    pac_md_eco_monedas
...
******************************************************************************//*************************************************************************
   ...
   *************************************************************************/
   FUNCTION f_obtener_cmoneda(
      pmoneda IN monedas.cmonint%TYPE,
      mensajes IN OUT t_iax_mensajes)
