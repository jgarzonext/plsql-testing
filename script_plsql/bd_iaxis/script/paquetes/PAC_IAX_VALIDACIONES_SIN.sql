--------------------------------------------------------
--  DDL for Package PAC_IAX_VALIDACIONES_SIN
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "AXIS"."PAC_IAX_VALIDACIONES_SIN" AS
   /******************************************************************************
     ...
     11.0        16/05/2012   JMF               11. 0022243 LCOL_S001-SIN - Impedir siniestros duplicados en el alta de siniestros (ID=4561)
     12.0        19/06/2012   JMF               12. 0022108 MDP_S001-SIN - Movimiento de tr¿mites
     13.0        24/10/2012   JMF               13. 0023826 MDP_S001-SIN - Presiniestros, ref_ext, y estimaci¿n reserva (Id=22769)
     14.0        13/08/2013   ASN               14. 0025537: RSA000 - Gesti¿n de incidencias (0150927/0150917)
     15.0        24/03/2014   NSS               15. 0024637/0147756: (POSAN500-AN-Sin) Analisis Desarrollo: Siniestros
     16.0        04/04/2014   NSS               16. 0030882: POSPG500-Informaci¿n del asegurado de productos innominados en alta de siniestros
     17.0        09/04/2014   NSS               17. 0030935: POSPG500-Control de alta de siniestros duplicados seg¿n garant¿a
     18.0       22/04/2014   NSS                18. 0029989/165377: LCOL_S001-SIN - Rechazo de tramitaci¿n ¿nica
     19.0        23/06/2016   AP                19. CONF-85 Fecha Real de Ocurrencia
   ******************************************************************************/
   ...
   *************************************************************************/
   ...
   /*************************************************************************
      FUNCTION f_cabecerapago
         ...
         param in psidepag  : Id. del pagament
         return             : 0 -> Tot correcte
                              1 -> S'ha produit un error
   *************************************************************************/
   ...
   *************************************************************************/
   ...
   /*************************************************************************
      FUNCTION f_valpresiniestro
         ...
         param in psproduc  : n¿mro producte
