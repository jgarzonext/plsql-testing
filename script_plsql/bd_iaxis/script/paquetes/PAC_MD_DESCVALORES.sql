--------------------------------------------------------
--  DDL for Package PAC_MD_DESCVALORES
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "AXIS"."PAC_MD_DESCVALORES" AS
/******************************************************************************
   ...
   2.0        27/04/2010   AMC                2. Bug 14284 Se a真ade la funci真n f_descgarant.
