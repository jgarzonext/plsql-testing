--------------------------------------------------------
--  DDL for Package PAC_MD_DINCARTERA
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "AXIS"."PAC_MD_DINCARTERA" AS
/******************************************************************************
   ...
   6.0        04/07/2013     ECP           7. 0027539: LCOL_T010-LCOL - Revision incidencias qtracker (VII). Nota 148366
******************************************************************************/
