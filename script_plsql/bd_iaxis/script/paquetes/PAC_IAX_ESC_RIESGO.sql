--------------------------------------------------------
--  DDL for Package PAC_IAX_ESC_RIESGO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "AXIS"."PAC_IAX_ESC_RIESGO" AS
/******************************************************************************
   ...
   ---------  ----------  ---------------  ------------------------------------
   1.0        23/01/2017   ERH               1. Creaci¿n del package.
...
******************************************************************************/
    ...
    /**********************************************************************
      ...
      Funcin que genera el calculo modelo de SCORING
      Firma (Specification):
