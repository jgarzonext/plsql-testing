--------------------------------------------------------
--  DDL for Package PAC_MD_UTILES
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "AXIS"."PAC_MD_UTILES" IS
   /******************************************************************************
      ...
      ---------  ----------  ---------------  ------------------------------------
      1.0        12/10/2016  JAE              1. Creación del objeto.
...
/
  ...
  GRANT EXECUTE ON "AXIS"."PAC_MD_UTILES" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."PAC_MD_UTILES" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."PAC_MD_UTILES" TO "PROGRAMADORESCSI";
