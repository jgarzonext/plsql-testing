create or replace PACKAGE        "PAC_MD_LISTVALORES_SIN" AS
/******************************************************************************
...
--   PROPÓSITO:  Funciones para recuperar valores
   ...
   ---------  ----------  ---------------  ------------------------------------
   1.0        25/02/2009   XVM                1. Creación del package.
   ...
   6.0        09/02/2010   JMF                6. Bug 0012822 CEM - RT - Tratamiento fiscal rentas a 2 cabezas
   7.0        05/03/2010   AMC                7. Bug 13312 se añade la funcion f_get_lsctestmov
   8.0        30/10/2010   JRH                8. BUG 15669 : Campos nuevos
   9.0        16/03/2011   JMF                9. 0017970: ENSA101- Campos pantallas de siniestros y mejoras
  10.0        01/07/2011   APD               10. 0018913: CRE998 - Afegir motiu de Rescats
  11.0		  29/03/2019   Swapnil		     11. Cambios de IAXIS-2168
******************************************************************************/
