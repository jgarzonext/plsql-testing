--------------------------------------------------------
--  DDL for Package PAC_AGENSEGU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "AXIS"."PAC_AGENSEGU" AS
/******************************************************************************
   NOMBRE:       pac_agensegu
...
/
  ...
  GRANT EXECUTE ON "AXIS"."PAC_AGENSEGU" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."PAC_AGENSEGU" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."PAC_AGENSEGU" TO "PROGRAMADORESCSI";
