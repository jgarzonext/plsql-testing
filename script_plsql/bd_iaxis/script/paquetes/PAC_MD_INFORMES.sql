--------------------------------------------------------
--  DDL for Package PAC_MD_INFORMES
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "AXIS"."PAC_MD_INFORMES" 
AS
/******************************************************************************
...
--
   ...
   ***********************************************************************/
   ...
   FUNCTION f_get_idiomasinforme(
      ...
      RETURN NUMBER;
   ---pac_md_informe Informe tecnico IAXIS 3602 Shubendu-----
...
/
  ...
  GRANT EXECUTE ON "AXIS"."PAC_MD_INFORMES" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."PAC_MD_INFORMES" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."PAC_MD_INFORMES" TO "PROGRAMADORESCSI";
