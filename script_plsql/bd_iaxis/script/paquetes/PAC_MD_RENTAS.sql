--------------------------------------------------------
--  DDL for Package PAC_MD_RENTAS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "AXIS"."PAC_MD_RENTAS" AS
/******************************************************************************
...
******************************************************************************/
   ...
   TYPE prodren IS RECORD(
      sproduc        NUMBER,
      cselecc        NUMBER
   );

   TYPE vtab_prodren IS TABLE OF prodren
