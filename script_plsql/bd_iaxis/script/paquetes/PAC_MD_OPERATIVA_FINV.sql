--------------------------------------------------------
--  DDL for Package PAC_MD_OPERATIVA_FINV
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "AXIS"."PAC_MD_OPERATIVA_FINV" IS
   /******************************************************************************
      ...
      3.0        25/09/2009   JGM                3. Bug 0011175
   ...
   ******************************************************************************/
   FUNCTION f_switch_importe(
     ...
     /*************************************************************************
      ...
      param in pcempres    : cÃ³digo de empresa
      param in pfvalor     : codigo de fecha de valoraciÃ³n
      param out mensajes  : mesajes de error
      return              : descripciÃ³n del acto
   *************************************************************************/
