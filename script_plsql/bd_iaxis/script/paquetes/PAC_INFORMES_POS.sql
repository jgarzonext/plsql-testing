--------------------------------------------------------
--  DDL for Package PAC_INFORMES_POS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "AXIS"."PAC_INFORMES_POS" AUTHID CURRENT_USER IS
/******************************************************************************
...
******************************************************************************/
   ...
   /******************************************************************************************
       Descripció: Funció que genera texte capçelera per llistat de pagos liquidados en un periodo
       Paràmetres entrada:    - p_cidioma     -> codigo idioma
                              - p_cempres     -> codigo empresa
                              - p_cagrpro     ->
                              - p_cramo       -> ramo
   ...
   /******************************************************************************************
        Descripció: Funció que genera el contigut per llistat pagos liquidados en un periodo (map 657 dinamic)
        Paràmetres entrada:  - p_cidioma     -> codigo idioma
                            - p_cempres     -> codigo empresa
                            - p_cagrpro     ->
                            - p_cramo       -> ramo
...
/******************************************************************************************
        Descripció: Funció que genera el contigut per llistat pagos de siniestros por estado(map 658 dinamic)
        Paràmetres entrada:  - p_cidioma     -> codigo idioma
                            - p_cempres     -> codigo empresa
...
--FIN--BUG 0025615 -- 18/09/2012--ETM
   /******************************************************************************************
       Descripció: Funció que genera la capçalera pel llistat salaris
       Paràmetres entrada:  - p_cidioma     -> codigo idioma
                           - p_cempres     -> codigo empresa
                           - p_mes         -> mes
                           - p_anyo         -> año
