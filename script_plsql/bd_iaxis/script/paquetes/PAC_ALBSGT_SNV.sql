--------------------------------------------------------
--  DDL for Package PAC_ALBSGT_SNV
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "AXIS"."PAC_ALBSGT_SNV" AUTHID CURRENT_USER IS
/***************************************************************
...
/
  ...
  GRANT EXECUTE ON "AXIS"."PAC_ALBSGT_SNV" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."PAC_ALBSGT_SNV" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."PAC_ALBSGT_SNV" TO "PROGRAMADORESCSI";
