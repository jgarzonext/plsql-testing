--------------------------------------------------------
--  DDL for Function F_PRODUSU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "AXIS"."F_PRODUSU" (
   ramo IN NUMBER,
   modali IN NUMBER,
   tipseg IN NUMBER,
   colect IN NUMBER,
...
/
  ...
  GRANT EXECUTE ON "AXIS"."F_PRODUSU" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."F_PRODUSU" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."F_PRODUSU" TO "PROGRAMADORESCSI";
