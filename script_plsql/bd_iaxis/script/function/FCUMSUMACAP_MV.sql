--------------------------------------------------------
--  DDL for Function FCUMSUMACAP_MV
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "AXIS"."FCUMSUMACAP_MV" (
   nsesion IN NUMBER,
   persona1 IN NUMBER,
   persona2 IN NUMBER,
   cumulo IN NUMBER,
...
/
  ...
  GRANT EXECUTE ON "AXIS"."FCUMSUMACAP_MV" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."FCUMSUMACAP_MV" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."FCUMSUMACAP_MV" TO "PROGRAMADORESCSI";
