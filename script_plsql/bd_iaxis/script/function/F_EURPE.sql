--------------------------------------------------------
--  DDL for Function F_EURPE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "AXIS"."F_EURPE" (pvalor IN NUMBER, pcdivisa IN NUMBER) RETURN NUMBER  IS
/***********************************************************************
...
/
  ...
  GRANT EXECUTE ON "AXIS"."F_EURPE" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."F_EURPE" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."F_EURPE" TO "PROGRAMADORESCSI";
