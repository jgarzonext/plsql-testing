--------------------------------------------------------
--  DDL for Function F_IMPORTE_PENDIENTE_ASIGNAR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "AXIS"."F_IMPORTE_PENDIENTE_ASIGNAR" (psseguro number,pfecha date) RETURN number IS
...
/
  ...
  GRANT EXECUTE ON "AXIS"."F_IMPORTE_PENDIENTE_ASIGNAR" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."F_IMPORTE_PENDIENTE_ASIGNAR" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."F_IMPORTE_PENDIENTE_ASIGNAR" TO "PROGRAMADORESCSI";
