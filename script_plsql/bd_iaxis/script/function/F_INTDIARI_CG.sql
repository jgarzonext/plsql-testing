--------------------------------------------------------
--  DDL for Function F_INTDIARI_CG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "AXIS"."F_INTDIARI_CG" (pcramo IN NUMBER, pcmodali IN NUMBER, pctipseg IN NUMBER,
...
------marcado por el tipo garantizado o el anual de ahorro------------
		...
		EXCEPTION
			WHEN NO_DATA_FOUND THEN
				RETURN 0;  -- No hay definido interés en INTERESPROD
		END;
	ELSE
		BEGIN
...
EXCEPTION
	WHEN OTHERS THEN
		RETURN 0;   		---Error al calcular los intereses
END;
...
/
  ...
  GRANT EXECUTE ON "AXIS"."F_INTDIARI_CG" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."F_INTDIARI_CG" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."F_INTDIARI_CG" TO "PROGRAMADORESCSI";
