--------------------------------------------------------
--  DDL for Function F_ASIGN_UNIDADES
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "AXIS"."F_ASIGN_UNIDADES" 
...
/
  ...
  GRANT EXECUTE ON "AXIS"."F_ASIGN_UNIDADES" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."F_ASIGN_UNIDADES" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."F_ASIGN_UNIDADES" TO "PROGRAMADORESCSI";
