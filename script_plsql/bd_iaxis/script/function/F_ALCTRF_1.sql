--------------------------------------------------------
--  DDL for Function F_ALCTRF_1
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "AXIS"."F_ALCTRF_1" (pedad IN NUMBER, pduracion IN NUMBER, paños IN NUMBER,
ppago IN NUMBER, pprovi IN OUT NUMBER)
RETURN NUMBER authid current_user IS
/**************************************************************************
	ALCTRF_1	Calculo de la fórmula PI, resultado intermedio,
...
--message('m40='||mxxk||'   m44='||mxxn||'   r41='||rxxk1||'   r45='||rxxn1||'   d40='||dxxk);pause;
	prod:=(mxxk-mxxn-(   (1/pduracion)*(rxxk1-rxxn1-
...
/
  ...
  GRANT EXECUTE ON "AXIS"."F_ALCTRF_1" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."F_ALCTRF_1" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."F_ALCTRF_1" TO "PROGRAMADORESCSI";
