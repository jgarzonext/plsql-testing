--------------------------------------------------------
--  DDL for Function F_FITXER_RESSINREA
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "AXIS"."F_FITXER_RESSINREA" (psproces IN NUMBER,pidioma IN NUMBER,
                                                pempres NUMBER, pfin DATE)
RETURN NUMBER AUTHID current_user IS
/***********************************************************************
	F_fitxer_Ressinrea : Crea el fitxer de les reserves de sinistres
...
BEGIN
   ...
   linia :=  'Cia Asseguradora;Data liquidació;Producte;Tram;Cia Reasseguradora; '||
			 ...
			 'Situació risc;Garantia;Import;%Propi;Imp.Propi;%Tram;Imp.Tram; '||
			 '%Cia;Imp.Cia;';
...
/
  ...
  GRANT EXECUTE ON "AXIS"."F_FITXER_RESSINREA" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."F_FITXER_RESSINREA" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."F_FITXER_RESSINREA" TO "PROGRAMADORESCSI";
