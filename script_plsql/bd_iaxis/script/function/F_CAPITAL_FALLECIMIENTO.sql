--------------------------------------------------------
--  DDL for Function F_CAPITAL_FALLECIMIENTO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "AXIS"."F_CAPITAL_FALLECIMIENTO" (psesion NUMBER, dummy NUMBER)
   RETURN NUMBER IS
...
/
  ...
  GRANT EXECUTE ON "AXIS"."F_CAPITAL_FALLECIMIENTO" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."F_CAPITAL_FALLECIMIENTO" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."F_CAPITAL_FALLECIMIENTO" TO "PROGRAMADORESCSI";
