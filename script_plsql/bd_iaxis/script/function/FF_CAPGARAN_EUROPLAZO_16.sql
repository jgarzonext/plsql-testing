--------------------------------------------------------
--  DDL for Function FF_CAPGARAN_EUROPLAZO_16
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "AXIS"."FF_CAPGARAN_EUROPLAZO_16" (sesion IN NUMBER, XINICI NUMBER, picapital IN NUMBER DEFAULT NULL) 
...
NDURACI:= pac_GFI.f_sgt_parms ('NDURACI', sesion);
...
NMOVIMI:= pac_GFI.f_sgt_parms ('NMOVIMI', sesion);
ORIGEN:= pac_GFI.f_sgt_parms ('ORIGEN', sesion);
GASTOS:= pac_GFI.f_sgt_parms ('GASTOS', sesion);
ACCION:= pac_GFI.f_sgt_parms ('ACCION', sesion);
FEFEPOL:= pac_GFI.f_sgt_parms ('FEFEPOL', sesion);

-- RSC 23/11/2007
Retorno := ff_capgaran_Europlazo16_Calc (sesion, XINICI, FECEFE, FEFEPOL,
                                         SSEGURO, SPRODUC, GARANTIA,
                                         NRIESGO, ORIGEN, NMOVIMI, NDURACI,
                                         NDURPER, FNACIMI, FNAC_ASE2, SEXO,
                                         SEXO_ASE2, PTIPOINT, ACCION, GASTOS, picapital);
/* 
...
/
  ...
  GRANT EXECUTE ON "AXIS"."FF_CAPGARAN_EUROPLAZO_16" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."FF_CAPGARAN_EUROPLAZO_16" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."FF_CAPGARAN_EUROPLAZO_16" TO "PROGRAMADORESCSI";
