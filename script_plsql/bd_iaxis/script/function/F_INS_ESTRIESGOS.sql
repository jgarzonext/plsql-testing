--------------------------------------------------------
--  DDL for Function F_INS_ESTRIESGOS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "AXIS"."F_INS_ESTRIESGOS" (psseguro IN NUMBER,
...
/
  ...
  GRANT EXECUTE ON "AXIS"."F_INS_ESTRIESGOS" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."F_INS_ESTRIESGOS" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."F_INS_ESTRIESGOS" TO "PROGRAMADORESCSI";
