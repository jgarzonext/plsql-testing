--------------------------------------------------------
--  DDL for Function F_DUPLICAR_PRODUCTO
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "AXIS"."F_DUPLICAR_PRODUCTO" (
   pcramo IN NUMBER,
   pcmodali IN NUMBER,
   pccolect IN NUMBER,
   pctipseg IN NUMBER,
...
/************************************************************************************************
   F_DUPPRODUCTO    Duplica un producte ( ALBERTO )
      ...
      Se debe controlar que si es una correduría no duplique el parámetro
      NOVATARIFA, ya que hay un trigger que lo inserta automáticamente en
      el insert de PRODUCTOS.
...
-- Se añaden los campos NPARBE, NBNS, CRECFRA, COFERSN
-- Se añade el campo CTARMAN
...
-- Se añade el campo COFERSN
-- Se añade el campo ctabla y tvalfor
   BEGIN
...
--   Fin de la modificación
   ...
   RETURN 0;
END f_duplicar_producto;

/

  GRANT EXECUTE ON "AXIS"."F_DUPLICAR_PRODUCTO" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."F_DUPLICAR_PRODUCTO" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."F_DUPLICAR_PRODUCTO" TO "PROGRAMADORESCSI";
