--------------------------------------------------------
--  DDL for Function F_BASEFNG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "AXIS"."F_BASEFNG" (
   psseguro IN NUMBER,
   pfdata IN DATE,
   pnriesgo IN NUMBER,
   pnerror OUT NUMBER)
...
--
-- ALLIBADM. OBTÉ LA BASE PEL CÀLCUL DEL FNG.
--
...
BEGIN
   IF psseguro IS NOT NULL
      ...
      WHILE cur_garant%FOUND LOOP
         ...
         IF xcimpfng = 1 THEN   -- S' OBTÉ LA BASE PEL CÀLCUL DEL FNG
            BEGIN
...
/
  ...
  GRANT EXECUTE ON "AXIS"."F_BASEFNG" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."F_BASEFNG" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."F_BASEFNG" TO "PROGRAMADORESCSI";
