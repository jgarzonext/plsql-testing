--------------------------------------------------------
--  DDL for Package Body PAC_MD_BONFRAN
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "AXIS"."PAC_MD_BONFRAN" AS
/******************************************************************************
   ...
   *************************************************************************/
   ...
   BEGIN
      numerr := pac_bonfran.f_set_deducible(pcgrup, pcsubgrup, pcversion, pcnivel, pcvalor1, pimpvalor1, pcimpmin, pimpmin, pcimpmax, pimpmax);
      vpasexec := 2;
   ...
   BEGIN
      numerr := pac_bonfran.f_validar_deducible_manual(pcgrup, pcsubgrup, pcversion, pcnivel, pcvalor1, pimpvalor1, pcimpmin, pimpmin, pcimpmax, pimpmax);
      vpasexec := 2;
