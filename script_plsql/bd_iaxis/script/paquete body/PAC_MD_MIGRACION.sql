CREATE OR REPLACE PACKAGE BODY pac_md_migracion AS
  /******************************************************************************
     NOMBRE:      pac_md_migracion
  ...
  *************************************************************************/
  FUNCTION f_consulta_poliza(pnpoliza IN VARCHAR2, psucursal IN NUMBER)
    ...
    vparam   VARCHAR2(2000) := 'pnpoliza= ' || pnpoliza || ' psucursal= ' ||
                               psucursal;
    vobject  VARCHAR2(200) := 'pac_md_migracion.f_consulta_poliza';
  BEGIN
    ...
    vnumerr := pac_migracion.f_consulta_poliza(pnpoliza, psucursal);
