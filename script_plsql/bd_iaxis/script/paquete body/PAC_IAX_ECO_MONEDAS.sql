--------------------------------------------------------
--  DDL for Package Body PAC_IAX_ECO_MONEDAS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "AXIS"."PAC_IAX_ECO_MONEDAS" AS
/******************************************************************************
   NOMBRE:       pac_iax_ADMIN
...
******************************************************************************/
   ...
   FUNCTION f_obtener_moneda_seguro2(
      ...
      vobjectname    VARCHAR2(500) := 'pac_iax_eco_monedas.f_obtener_moneda_seguro2';
   ...
   BEGIN
      ...
      vpasexec := 102;
      vret := pac_md_eco_monedas.f_obtener_moneda_seguro2(psseguro, mensajes);
      vpasexec := 103;
   ...
   FUNCTION f_obtener_moneda_producto2(
      ...
      mensajes OUT t_iax_mensajes)
      RETURN eco_codmonedas.cmoneda%TYPE IS
      vobjectname    VARCHAR2(500) := 'pac_iax_eco_monedas.f_obtener_moneda_producto2';
   ...
   BEGIN
      ...
      vpasexec := 102;
      vret := pac_md_eco_monedas.f_obtener_moneda_producto2(psproduc, mensajes);
      vpasexec := 103;
   ...
   FUNCTION f_obtener_cmonint(pmoneda IN monedas.cmoneda%TYPE, mensajes OUT t_iax_mensajes)
      ...
      vobjectname    VARCHAR2(500) := 'pac_iax_eco_monedas.f_obtener_cmonint';
   ...
   BEGIN
      ...
      vpasexec := 102;
      vret := pac_md_eco_monedas.f_obtener_cmonint(pmoneda, mensajes);
      vpasexec := 103;
   ...
   FUNCTION f_obtener_cmoneda(pmoneda IN monedas.cmonint%TYPE, mensajes OUT t_iax_mensajes)
      ...
      vobjectname    VARCHAR2(500) := 'pac_iax_eco_monedas.f_obtener_cmoneda';
      vparam         VARCHAR2(500) := 'parámetros - pmoneda: ' || pmoneda;
      vpasexec       NUMBER(5) := 100;
   ...
   BEGIN
      ...
      vpasexec := 102;
      vret := pac_md_eco_monedas.f_obtener_cmoneda(pmoneda, mensajes);
      vpasexec := 103;
