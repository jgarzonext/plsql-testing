--------------------------------------------------------
--  DDL for Package Body PAC_MD_COMISI_ADQUI
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "AXIS"."PAC_MD_COMISI_ADQUI" AS
   ...
   FUNCTION f_obtener_polizas(
      ...
      v_param        VARCHAR2(200)
         := 'p_cagente=' || p_cagente || ' p_tagente=' || p_tagente || ' p_npoliza='
            ...
            || ' p_hasta=' || p_hasta;
      v_object       VARCHAR2(200) := 'PAC_MD_COMISI_ADQUI.F_OBTENER_POLIZAS';
      v_numerr       NUMBER(10);
   BEGIN
   ...
   FUNCTION f_obtener_total_comis(
      ...
      v_object       VARCHAR2(200) := 'PAC_MD_COMISI_ADQUI.F_OBTENER_TOTAL_COMIS';
      v_numerr       NUMBER(10);
   BEGIN
   ...
   FUNCTION f_obtener_comisiones(
      ...
      v_pasexec      NUMBER(8) := 1;
      v_param        VARCHAR2(200) := 'p_sseguro=' || p_sseguro;
      v_object       VARCHAR2(200) := 'PAC_MD_COMISI_ADQUI.F_OBTENER_COMISIONES';
      v_numerr       NUMBER(10);
   BEGIN
