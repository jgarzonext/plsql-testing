--------------------------------------------------------
--  DDL for Procedure P_PERMISOS_USERS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "AXIS"."P_PERMISOS_USERS" IS
...
/
  ...
  GRANT EXECUTE ON "AXIS"."P_PERMISOS_USERS" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."P_PERMISOS_USERS" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."P_PERMISOS_USERS" TO "PROGRAMADORESCSI";
