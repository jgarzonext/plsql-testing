--------------------------------------------------------
--  DDL for Type OB_IAX_INTTECGARANTIAS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TYPE "AXIS"."OB_IAX_INTTECGARANTIAS" AS OBJECT
/******************************************************************************
   NOMBRE:       OB_IAX_INTTECGARANTIAS
...
(
   ...
   CONSTRUCTOR FUNCTION ob_iax_inttecgarantias
      RETURN SELF AS RESULT
);
/
CREATE OR REPLACE EDITIONABLE TYPE BODY "AXIS"."OB_IAX_INTTECGARANTIAS" AS
   CONSTRUCTOR FUNCTION ob_iax_inttecgarantias
...
/
  ...
  GRANT EXECUTE ON "AXIS"."OB_IAX_INTTECGARANTIAS" TO "R_AXIS";
  GRANT EXECUTE ON "AXIS"."OB_IAX_INTTECGARANTIAS" TO "CONF_DWH";
  GRANT EXECUTE ON "AXIS"."OB_IAX_INTTECGARANTIAS" TO "PROGRAMADORESCSI";
