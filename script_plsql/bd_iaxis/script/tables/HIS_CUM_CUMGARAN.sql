...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "AXIS" ;
   ...
   COMMENT ON COLUMN "AXIS"."HIS_CUM_CUMGARAN"."CGARANT" IS 'Codigo de la garantía';
   COMMENT ON COLUMN "AXIS"."HIS_CUM_CUMGARAN"."CCUMULO" IS 'Clave del Cúmulo';
   ...
   COMMENT ON COLUMN "AXIS"."HIS_CUM_CUMGARAN"."CUSUHIST" IS 'Usuario que realiza la acción';
   COMMENT ON COLUMN "AXIS"."HIS_CUM_CUMGARAN"."FCREAHIST" IS 'Fecha en que se realiza la acción';
   COMMENT ON COLUMN "AXIS"."HIS_CUM_CUMGARAN"."ACCION" IS 'Acción realizada';
   COMMENT ON TABLE "AXIS"."HIS_CUM_CUMGARAN"  IS 'Histórico de la tabla CUM_CUMGARAN';
