...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "AXIS" ;
   ...
   COMMENT ON COLUMN "AXIS"."CODGRUPPROFESIOPROD"."CGRUPPRO" IS 'Código de grupo de profesión';
   COMMENT ON TABLE "AXIS"."CODGRUPPROFESIOPROD"  IS 'Código de grupo de profesiones por producto';
