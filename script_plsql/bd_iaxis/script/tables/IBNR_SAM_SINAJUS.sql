...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "AXIS" ;
   ...
   COMMENT ON COLUMN "AXIS"."IBNR_SAM_SINAJUS"."FCALCUL" IS 'Fecha del cálculo (real)';
   ...
   COMMENT ON COLUMN "AXIS"."IBNR_SAM_SINAJUS"."CTIPO" IS 'Tipo de inflación  (0 - pagos , 1- reservas)';
   ...
   COMMENT ON COLUMN "AXIS"."IBNR_SAM_SINAJUS"."CGARANT" IS 'Identificador de la garantía';
   COMMENT ON COLUMN "AXIS"."IBNR_SAM_SINAJUS"."SPRODUC" IS 'Identificador del producto';
   COMMENT ON TABLE "AXIS"."IBNR_SAM_SINAJUS"  IS 'Tabla de Triángulo de siniestros pag./res. ajustados';
