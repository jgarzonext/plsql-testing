...
--------------------------------------------------------
 ...
 NOCOMPRESS NOLOGGING
  ...
  TABLESPACE "AXIS" ;
   ...
   COMMENT ON COLUMN "AXIS"."DETMOVSEGURO"."CMOTMOV" IS 'Código del motivo de movimiento';
   COMMENT ON COLUMN "AXIS"."DETMOVSEGURO"."NRIESGO" IS 'Id.del riesgo';
   COMMENT ON COLUMN "AXIS"."DETMOVSEGURO"."CGARANT" IS 'Código de la garantia';
   ...
   COMMENT ON COLUMN "AXIS"."DETMOVSEGURO"."CPREGUN" IS 'Código de la pregunta';
