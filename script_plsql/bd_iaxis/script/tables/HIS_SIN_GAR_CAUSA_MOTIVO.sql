...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "AXIS" ;
   ...
   COMMENT ON COLUMN "AXIS"."HIS_SIN_GAR_CAUSA_MOTIVO"."CACTIVI" IS 'Código Actividad';
   COMMENT ON COLUMN "AXIS"."HIS_SIN_GAR_CAUSA_MOTIVO"."CGARANT" IS 'Código Garantía';
   COMMENT ON COLUMN "AXIS"."HIS_SIN_GAR_CAUSA_MOTIVO"."CTRAMIT" IS 'Código Tramitación';
   COMMENT ON COLUMN "AXIS"."HIS_SIN_GAR_CAUSA_MOTIVO"."CUSUALT" IS 'Código Usuario Alta';
   COMMENT ON COLUMN "AXIS"."HIS_SIN_GAR_CAUSA_MOTIVO"."FALTA" IS 'Fecha Alta';
   COMMENT ON COLUMN "AXIS"."HIS_SIN_GAR_CAUSA_MOTIVO"."CUSUMOD" IS 'Código Usuario Modificación';
   COMMENT ON COLUMN "AXIS"."HIS_SIN_GAR_CAUSA_MOTIVO"."FMODIFI" IS 'Fecha Modificación';
   ...
   COMMENT ON COLUMN "AXIS"."HIS_SIN_GAR_CAUSA_MOTIVO"."CUSUHIST" IS 'Usuario que realiza la acción';
   COMMENT ON COLUMN "AXIS"."HIS_SIN_GAR_CAUSA_MOTIVO"."FCREAHIST" IS 'Fecha en que se realiza la acción';
   COMMENT ON COLUMN "AXIS"."HIS_SIN_GAR_CAUSA_MOTIVO"."ACCION" IS 'Acción realizada';
   COMMENT ON TABLE "AXIS"."HIS_SIN_GAR_CAUSA_MOTIVO"  IS 'Histórico de la tabla SIN_GAR_CAUSA_MOTIVO';
