...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "AXIS" ;
   ...
   COMMENT ON COLUMN "AXIS"."INT_DATOS_DIRECCION"."CTIPDIR" IS 'Id del tipo de dirección (1 Particular, 2 Envío, etc)';
   COMMENT ON COLUMN "AXIS"."INT_DATOS_DIRECCION"."TNOMVIA" IS 'Nombre de la vía.';
   COMMENT ON COLUMN "AXIS"."INT_DATOS_DIRECCION"."NNUMVIA" IS 'Número de la vía.';
   COMMENT ON COLUMN "AXIS"."INT_DATOS_DIRECCION"."TDESC" IS 'Descripción complementaria.';
   COMMENT ON COLUMN "AXIS"."INT_DATOS_DIRECCION"."CPOSTAL" IS 'Código postal.';
   COMMENT ON COLUMN "AXIS"."INT_DATOS_DIRECCION"."CPOBLAC" IS 'Id del código de población.';
   COMMENT ON COLUMN "AXIS"."INT_DATOS_DIRECCION"."CPROVIN" IS 'Id del código de la provincia.';
   COMMENT ON COLUMN "AXIS"."INT_DATOS_DIRECCION"."CPAIS" IS 'Id del país.';
