...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "AXIS" ;
   ...
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."NCARGA" IS 'Número de carga';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."CESTMIG" IS 'Estado del registro';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."MIG_PK" IS 'Clave única';
   ...
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."CTIPRES" IS 'Código Tipo Reserva';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."NMOVRES" IS 'Número Movimiento Reserva';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."CGARANT" IS 'Código Garantía';
   ...
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."CMONRES" IS 'Código Moneda Reserva';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."ISINRET" IS 'Importe Sin Retención';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."IRETENC" IS 'Importe Retención';
   ...
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."CMONPAG" IS 'Código Moneda Pago';
   ...
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."IRETENCPAG" IS 'Importe Retención Moneda Pago';
   ...
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."PRETENC" IS 'Porcentaje Retención';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."PIVA" IS 'Porcentaje IVA';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."CUSUALT" IS 'Código Usuario Alta';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."FALTA" IS 'Fecha Alta';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."CUSUMOD" IS 'Código Usuario Modificación';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."FMODIFI" IS 'Fecha Modificación';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."CCONPAG" IS 'Código de concepto';
   ...
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."IRETEIVA" IS 'Importe de retención sobre el IVA';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."IRETEICA" IS 'Importe de retención sobre el ICA';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."PICA" IS 'Porcentaje ICA';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."PRETEIVA" IS 'Porcentaje de retención sobre el IVA';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."PRETEICA" IS 'Porcentaje de retención sobre el ICA';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."CAPLFRA" IS 'Aplica franquicia 0=No, 1=Sí';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."IICAPAG" IS 'Importe ICA Moneda Pago';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."IRETEIVAPAG" IS 'Importe de retención sobre el IVA Moneda Pago';
   COMMENT ON COLUMN "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"."IRETEICAPAG" IS 'Importe de retención sobre el ICA Moneda Pago';
   ...
   COMMENT ON TABLE "AXIS"."MIG_SIN_TRAMITA_PAGO_GAR"  IS 'Tabla para la migración de mig_sin_tramita_pago.';
