...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "AXIS" ;
   ...
   COMMENT ON COLUMN "AXIS"."ESTDOCREQUERIDA"."SEQDOCU" IS 'Número secuencial de documento';
   COMMENT ON COLUMN "AXIS"."ESTDOCREQUERIDA"."CDOCUME" IS 'Código de documento';
   COMMENT ON COLUMN "AXIS"."ESTDOCREQUERIDA"."SPRODUC" IS 'Código de producto';
   COMMENT ON COLUMN "AXIS"."ESTDOCREQUERIDA"."CACTIVI" IS 'Código de actividad';
   COMMENT ON COLUMN "AXIS"."ESTDOCREQUERIDA"."NORDEN" IS 'Número de orden';
   COMMENT ON COLUMN "AXIS"."ESTDOCREQUERIDA"."CTIPDOC" IS 'Tipo de documento (VF. 1031)';
   COMMENT ON COLUMN "AXIS"."ESTDOCREQUERIDA"."CCLASE" IS 'Clase de parametrización (VF. 1032)';
   COMMENT ON COLUMN "AXIS"."ESTDOCREQUERIDA"."SSEGURO" IS 'Número secuencial de seguro';
   COMMENT ON COLUMN "AXIS"."ESTDOCREQUERIDA"."NMOVIMI" IS 'Número de movimiento';
   COMMENT ON COLUMN "AXIS"."ESTDOCREQUERIDA"."TFILENAME" IS 'Nombre del fichero';
   COMMENT ON COLUMN "AXIS"."ESTDOCREQUERIDA"."TDESCRIP" IS 'Descripción';
   ...
   COMMENT ON TABLE "AXIS"."ESTDOCREQUERIDA"  IS 'Tabla temporal de documentación requerida de un contrato';
