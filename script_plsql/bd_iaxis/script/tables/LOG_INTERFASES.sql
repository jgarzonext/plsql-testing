...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "AXIS" ;
   ...
   COMMENT ON COLUMN "AXIS"."LOG_INTERFASES"."CUSUARIO" IS 'Código de usuario';
   COMMENT ON COLUMN "AXIS"."LOG_INTERFASES"."FINTERF" IS 'Fecha interface';
   COMMENT ON COLUMN "AXIS"."LOG_INTERFASES"."SINTERF" IS 'Código de seqüencia de interface';
   COMMENT ON COLUMN "AXIS"."LOG_INTERFASES"."CINTERF" IS 'Código de interface';
