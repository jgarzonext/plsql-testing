...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "AXIS" ;
   ...
   COMMENT ON COLUMN "AXIS"."HIS_PSU_CODCONTROL"."CCONTROL" IS 'Código de Control';
   COMMENT ON COLUMN "AXIS"."HIS_PSU_CODCONTROL"."CUSUALT" IS 'Usuario Creación';
   COMMENT ON COLUMN "AXIS"."HIS_PSU_CODCONTROL"."FALTA" IS 'Fecha de alta del registro';
   COMMENT ON COLUMN "AXIS"."HIS_PSU_CODCONTROL"."CUSUMOD" IS 'Usurio Modificación';
   COMMENT ON COLUMN "AXIS"."HIS_PSU_CODCONTROL"."FMODIFI" IS 'Fecha de Modificación';
   COMMENT ON TABLE "AXIS"."HIS_PSU_CODCONTROL"  IS 'Códigos de Control';
