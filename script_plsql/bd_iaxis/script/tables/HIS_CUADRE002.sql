...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "AXIS" ;
   ...
   COMMENT ON COLUMN "AXIS"."HIS_CUADRE002"."COM_DEVEN" IS 'Comisión devengada';
   COMMENT ON COLUMN "AXIS"."HIS_CUADRE002"."CTIPCOA" IS 'Código tipo de coaseguro';
   COMMENT ON TABLE "AXIS"."HIS_CUADRE002"  IS 'Recibos anulados en el mes emitidos en el año pasado';
