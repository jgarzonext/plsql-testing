...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "AXIS" ;
  GRANT UPDATE ON "AXIS"."VENTAS" TO "R_AXIS";
  GRANT SELECT ON "AXIS"."VENTAS" TO "R_AXIS";
  GRANT INSERT ON "AXIS"."VENTAS" TO "R_AXIS";
  GRANT DELETE ON "AXIS"."VENTAS" TO "R_AXIS";
  GRANT SELECT ON "AXIS"."VENTAS" TO "CONF_DWH";
  GRANT SELECT ON "AXIS"."VENTAS" TO "PROGRAMADORESCSI";
