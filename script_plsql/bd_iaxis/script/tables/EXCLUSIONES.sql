...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "AXIS" ;
   ...
   COMMENT ON COLUMN "AXIS"."EXCLUSIONES"."CEXCLU" IS 'Código de exclusion';
   COMMENT ON COLUMN "AXIS"."EXCLUSIONES"."CIDIOMA" IS 'Código del Idioma. 1.- Català  2.- Castellano';
   COMMENT ON COLUMN "AXIS"."EXCLUSIONES"."TEXCLU" IS 'Texto de la exclusión';
   COMMENT ON TABLE "AXIS"."EXCLUSIONES"  IS 'Descripción de exclusiones';
