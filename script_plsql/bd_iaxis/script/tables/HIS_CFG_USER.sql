...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "AXIS" ;
   ...
   COMMENT ON COLUMN "AXIS"."HIS_CFG_USER"."CCFGWIZ" IS 'Id. del tipo de configuración de navegación asociada al usuario';
   COMMENT ON COLUMN "AXIS"."HIS_CFG_USER"."CCFGFORM" IS 'Id. del tipo de configuración de formularios asociada al usuario';
   COMMENT ON COLUMN "AXIS"."HIS_CFG_USER"."CCFGACC" IS 'Id. de la configuración de acciones asociada al usuario';
   COMMENT ON COLUMN "AXIS"."HIS_CFG_USER"."CCFGDOC" IS 'Id. de la configuración de acceso a documentación del usuario';
   ...
   COMMENT ON TABLE "AXIS"."HIS_CFG_USER"  IS 'Tabla de configuración de usuarios donde se indica las configuraciones por defecto (de navegación, formulario, acciones, etc) asociadas a los usuarios de la aplicación';
