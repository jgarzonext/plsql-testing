...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "AXIS" ;
   ...
   COMMENT ON COLUMN "AXIS"."DELPER_SARLAFT"."SPERSON" IS 'Secuencia única de identificación de una persona';
   COMMENT ON COLUMN "AXIS"."DELPER_SARLAFT"."CAGENTE" IS 'Código de agente';
   COMMENT ON COLUMN "AXIS"."DELPER_SARLAFT"."FEFECTO" IS 'Fecha de efecto del documento SARLAFT';
   COMMENT ON COLUMN "AXIS"."DELPER_SARLAFT"."CUSUALT" IS 'Código usuario alta del registro';
   COMMENT ON COLUMN "AXIS"."DELPER_SARLAFT"."FALTA" IS 'Fecha de alta del registro';
   COMMENT ON COLUMN "AXIS"."DELPER_SARLAFT"."CUSUARI" IS 'Código usuario modificación del registro';
   COMMENT ON COLUMN "AXIS"."DELPER_SARLAFT"."FMOVIMI" IS 'Fecha de modificación del registro';
