...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "AXIS" ;
   ...
   COMMENT ON COLUMN "AXIS"."HIS_CUADRE05"."COM_DEVEN" IS 'Comisión devengada';
   COMMENT ON COLUMN "AXIS"."HIS_CUADRE05"."CTIPCOA" IS 'Código tipo de coaseguro';
   COMMENT ON TABLE "AXIS"."HIS_CUADRE05"  IS 'Recibos cobrados en el mes emitidos en el año';
