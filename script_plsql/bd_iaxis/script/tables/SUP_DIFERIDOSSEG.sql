...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "AXIS" ;
   ...
   COMMENT ON COLUMN "AXIS"."SUP_DIFERIDOSSEG"."CMOTMOV" IS 'Fecha de alta de la póliza';
   ...
   COMMENT ON COLUMN "AXIS"."SUP_DIFERIDOSSEG"."FVALFUN" IS 'Función de validación';
   ...
   COMMENT ON COLUMN "AXIS"."SUP_DIFERIDOSSEG"."FANULA" IS 'Fecha de anulación';
   COMMENT ON COLUMN "AXIS"."SUP_DIFERIDOSSEG"."NMOVIMI" IS 'Número de movimiento del certificado 0 (de movseguro)';
   COMMENT ON COLUMN "AXIS"."SUP_DIFERIDOSSEG"."NEJECU" IS 'Número de ejecución del diferido para el mismo suplemento-seguro';
   COMMENT ON TABLE "AXIS"."SUP_DIFERIDOSSEG"  IS 'Parametrización via AXIS de suplementos diferidos';
