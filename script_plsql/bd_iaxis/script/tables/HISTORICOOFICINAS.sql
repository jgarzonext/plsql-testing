...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "AXIS" ;
   ...
   COMMENT ON COLUMN "AXIS"."HISTORICOOFICINAS"."SSEGURO" IS 'Número de secuencia de seguro';
   COMMENT ON COLUMN "AXIS"."HISTORICOOFICINAS"."COFICIN" IS 'Código de oficina';
