--------------------------------------------------------
--  DDL for Trigger TRG_MOVPAGOS_CTATEC_REA
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "AXIS"."TRG_MOVPAGOS_CTATEC_REA" 
...
BEGIN
   IF INSERTING THEN
      ...
      INSERT INTO movpagos_ctatec_rea
                  (smovpagrea, spagrea, cempres, ccompani,
                   sproduc, iimporte, iimporte_moncon, cestant, cestado,
                   falta, fliquida, fcontab)
           VALUES (smovpagrea.NEXTVAL, :NEW.spagrea, :NEW.cempres, :NEW.ccompani,
   ...
   ELSIF UPDATING THEN
      ...
      IF :OLD.cestado <> :NEW.cestado THEN
         INSERT INTO movpagos_ctatec_rea
              ...
              VALUES (smovpagrea.NEXTVAL, :OLD.spagrea, :OLD.cempres, :OLD.ccompani,
...
EXCEPTION
   WHEN OTHERS THEN
      p_tab_error(f_sysdate, f_user, 'TRIGGER TRG_MOVPAGOS_CTATEC_REA', 1, SQLCODE, SQLERRM);
END trg_pagos_ctatec_rea;
...
/
ALTER TRIGGER "AXIS"."TRG_MOVPAGOS_CTATEC_REA" ENABLE;
